...
If you aren't very familiar with Linux, or just want to get up and running, the easiest way to get started with CrispyBox is to download a [pre-built CrispyBox](https://github.com/APrettyCoolProgram/CrispyBox/blob/master/Get_pre-built.md). There are a few things you'll need to do, but for the most part all of the hard work has been done, and you'll be up and running in no time.
